...
class Controller {
  ...
  initOnscreenController() {
    ...
    fireBtn.style.cssText = "position:absolute; bottom:55px; width:40px; height:40px; background:#ffffff; border:#444 solid medium; border-radius:50%; left:50%; tranform:translateX(-50%);";
